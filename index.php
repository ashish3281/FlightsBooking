<!DOCTYPE html>
<title>Online flights Booking</title>
<html lang="en">
    <?php
    session_start();
    ob_start();
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> <?php echo $_SESSION['setting_name'] ?> | <a href="https://github.com/Xxmostafaahmed" target="_blank">GitHub</a></div></div>
        </footer>
